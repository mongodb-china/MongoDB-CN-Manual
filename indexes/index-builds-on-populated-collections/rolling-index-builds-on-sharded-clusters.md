...
在为切分构建完索引之后，重复[C\]。在包含集合块的切分上为其他受影响的切分构建索引](https://docs.mongodb.com/master/tutorial/build-indexes-on-%20shard-clusters/%20#tutorial-index-on-affected-shards)。
