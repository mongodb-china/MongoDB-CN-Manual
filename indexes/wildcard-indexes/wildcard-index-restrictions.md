...
* [不兼容的索引类型或属性](wildcard-index-restrictions.md#不兼容)
* [不支持的查询和聚合模式](wildcard-index-restrictions.md#不支持)
* [分片](wildcard-index-restrictions.md#分片)
...
例如，考虑一个在 product\_attributes 上具有通配符索引的集合目录。通配符索引不能支持以下查询:
