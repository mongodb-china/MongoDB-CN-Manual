...
* [总览](geojson-objects.md#概观)
* [`Point`](geojson-objects.md#点)
* [`LineString`](geojson-objects.md#线串)
* [多边形](geojson-objects.md#多边形)
* [多点](geojson-objects.md#多点)
* [MULTILINESTRING](geojson-objects.md#id1)
* [MultiPolygon](geojson-objects.md#id2)
* [GeometryCollection](geojson-objects.md#id3)
