...
要返回更新文档的最新多数批准版本，请传递full\_document='updateLookup'到 db.collection.watch\(\)方法。
...
恢复令牌\_data类型取决于MongoDB版本，在某些情况下，取决于更改流打开/恢复时的功能兼容性版本（fcv）（即，fcv值的更改不会影响已打开的更改流的恢复令牌。 ）：
